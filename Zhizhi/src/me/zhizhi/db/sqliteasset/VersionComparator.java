package me.zhizhi.db.sqliteasset;

import java.util.Comparator;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import me.zhizhi.db.sqliteasset.SQLiteAssetHelper.SQLiteAssetException;
...
class VersionComparator implements Comparator<String> {
     ...
     *
     * @exception SQLiteAssetException thrown if the strings are not in the
     *            correct upgrade script format of:
