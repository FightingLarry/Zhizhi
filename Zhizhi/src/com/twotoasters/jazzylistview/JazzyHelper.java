...
public class JazzyHelper implements AbsListView.OnScrollListener {
    ...
    public JazzyHelper(Context context, AttributeSet attrs) {
        ...
        mOnlyAnimateNewItems = a
                .getBoolean(R.styleable.JazzyListView_only_animate_new_items, false);
        mOnlyAnimateOnFling = a.getBoolean(R.styleable.JazzyListView_max_velocity, false);
        mSimulateGridWithList = a.getBoolean(R.styleable.JazzyListView_simulate_grid_with_list,
                false);
        a.recycle();
     ...
     * 
     * @param firstVisibleItem The index of the first visible item in the
     *        ListView.
     */
     ...
     * @param scrollDirection Positive number indicating scrolling down, or
     *        negative number indicating scrolling up.
     */
    ...
    private void doJazzinessImpl(View item, int position, int scrollDirection) {
        ViewPropertyAnimator animator = com.nineoldandroids.view.ViewPropertyAnimator.animate(item)
                .setDuration(DURATION).setInterpolator(new AccelerateDecelerateInterpolator());
     ...
     */
    private void notifyAdditionalOnScrollListener(AbsListView view, int firstVisibleItem,
            int visibleItemCount, int totalItemCount) {
        if (mAdditionalOnScrollListener != null) {
            mAdditionalOnScrollListener.onScroll(view, firstVisibleItem, visibleItemCount,
                    totalItemCount);
        }
    }

    /**
     * Notifies the OnScrollListener of an onScrollStateChanged event,
     * since JazzyListView is the primary listener for onScrollStateChanged
     * events.
     */
